            ...
            <div className="row">
              <div className="col s12 m4">
                <div className="icon-block">
                  <h2 className="center brown-text"><i className="material-icons">airplanemode_active</i></h2>
              ...
              <div className="col s12 m4">
                <div className="icon-block">
                  ...
                  <p className="light">Create a group and invite your friends or join an existing group and meet new people.</p>
                </div>
              </div>

              <div className="col s12 m4">
                <div className="icon-block">
                  <h2 className="center brown-text"><i className="material-icons">blur_on</i></h2>
                  <h5 className="center">Virtual Reality</h5>

                  <p className="light">Take a 360&deg; virtual tour of just about any city using images from Google Maps.</p>
                </div>
              </div>
            </div>
